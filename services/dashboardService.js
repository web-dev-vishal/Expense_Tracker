...
// Constants for time periods (no more magic numbers!)
const TIME_PERIODS = {
...
exports.getDashboardData = async (userId) => {
    try {
        ...
        const monthlySavings = incomeLast60Days / 2 - expensesLast30Days; // Approximate monthly savings
        ...
        // If Redis fails, still return data from DB (no cache)
        console.error('⚠️ Dashboard Error:', error.message);
        throw error;
    }
};
 ...
 * Called when income or expense is added/deleted
 */
